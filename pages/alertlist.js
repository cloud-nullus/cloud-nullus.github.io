                    ...
                    <div class="pipeline-card" style="padding:24px;">
                        ...
                        <div style="display:flex;flex-direction:column;gap:12px;">
                            ...
                            <div style="padding:12px;border:1.5px solid #2d3748;border-radius:8px;">
                                <div style="font-weight:600;font-size:13px;color:#e2e8f0;margin-bottom:8px;"><span data-i18n="alert.threshold">임계값</span></div>
                                <div style="display:flex;flex-direction:column;gap:8px;">
                                    <div style="display:flex;align-items:center;justify-content:space-between;font-size:13px;"><span style="color:#94a3b8;">CPU &gt;</span><input type="number" value="80" style="width:60px;padding:4px 8px;border:1px solid #2d3748;border-radius:6px;font-size:13px;text-align:center;background:#1e293b;color:#e2e8f0;"><span style="color:#94a3b8;">%</span></div>
                                    <div style="display:flex;align-items:center;justify-content:space-between;font-size:13px;"><span style="color:#94a3b8;">Memory &gt;</span><input type="number" value="85" style="width:60px;padding:4px 8px;border:1px solid #2d3748;border-radius:6px;font-size:13px;text-align:center;background:#1e293b;color:#e2e8f0;"><span style="color:#94a3b8;">%</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
