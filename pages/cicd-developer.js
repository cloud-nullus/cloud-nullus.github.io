                    ...
                    <div class="developer-layout">
                        <div class="developer-left">
                            <div class="developer-section-head">
                                <p>Backstage-style developer workflow: choose a template and deploy to target cluster/namespace.</p>
                            </div>

                            <!-- Category Filter (기능 5) -->
                            <div style="display:flex;gap:8px;margin-bottom:16px;flex-wrap:wrap;">
                                <button class="template-category-btn active" data-category="all" onclick="filterDevTemplates('all',this)">All</button>
                                <button class="template-category-btn" data-category="web" onclick="filterDevTemplates('web',this)"><i class="fas fa-globe"></i> Web</button>
                                <button class="template-category-btn" data-category="backend" onclick="filterDevTemplates('backend',this)"><i class="fas fa-server"></i> Backend</button>
                                <button class="template-category-btn" data-category="batch" onclick="filterDevTemplates('batch',this)"><i class="fas fa-layer-group"></i> Batch</button>
                            </div>
                            ...
                            <div class="developer-template-grid" id="developerTemplateGrid">
                                ...
                                <article class="developer-template-card selected" data-template="react-spa" data-language="React" data-type="web">
                                    <div class="template-card-top">
                                        <span class="template-badge" style="background:#e0f2fe;color:#0369a1;">Web</span>
                                        <i class="fab fa-react"></i>
                                    </div>
                                    <h3>React SPA</h3>
                                    <p>TypeScript + Vite + Nginx deployment template for frontend teams.</p>
                                ...
                                <article class="developer-template-card" data-template="nextjs" data-language="Node.js" data-type="web">
                                    ...
                                    <h3>Next.js SSR</h3>
                                    <p>Server-side rendering with Next.js, optimized for production K8s.</p>
                                ...
                                <article class="developer-template-card" data-template="spring-api" data-language="Java" data-type="backend">
                                    <div class="template-card-top">
                                        <span class="template-badge" style="background:#f0fdf4;color:#15803d;">Backend</span>
                                        <i class="fab fa-java"></i>
                                    </div>
                                    <h3>Java Spring Boot API</h3>
                                    <p>REST API starter with Actuator health checks and container best practices.</p>
                                ...
                                <article class="developer-template-card" data-template="python-fastapi" data-language="Python" data-type="backend">
                                    ...
                                    <p>FastAPI starter with uvicorn, OpenAPI docs, and production Docker setup.</p>
                                ...
                                <article class="developer-template-card" data-template="go-microservice" data-language="Go" data-type="backend">
                                    ...
                                    <p>Go HTTP service with health probes, metrics endpoint, and small image footprint.</p>
                                ...
                                <article class="developer-template-card" data-template="python-batch" data-language="Python" data-type="batch">
                                    <div class="template-card-top">
                                        <span class="template-badge" style="background:#fef3c7;color:#b45309;">Batch</span>
                                        <i class="fab fa-python"></i>
                                    </div>
                                    <h3>Python Batch Job</h3>
                                    <p>Kubernetes CronJob template for scheduled Python batch processing.</p>
                                ...
                                <article class="developer-template-card" data-template="java-batch" data-language="Java" data-type="batch">
                                    ...
                                    <h3>Spring Batch Job</h3>
                                    <p>Spring Batch on Kubernetes with Job/CronJob scheduling and retry logic.</p>
                            ...
                            <div class="status-card developer-wizard-card">
                                ...
                                <div class="status-card-content">
                                    <div class="developer-stepper">
                                        <span class="active">1. App Config</span>
                                        <span>2. Cluster & Namespace</span>
                                        <span>3. Resources</span>
                                        <span>4. Env & Secrets</span>
                                        <span>5. Review & Deploy</span>
                                    </div>
                                    ...
                                    <div class="developer-resource-toggle-row">
                                        <label><input type="checkbox" class="dev-resource-toggle" id="devEnableDb"> PostgreSQL DB</label>
                                        <label><input type="checkbox" class="dev-resource-toggle" id="devEnableRedis"> Redis Cache</label>
                                        <label><input type="checkbox" class="dev-resource-toggle" id="devEnableQueue"> Message Queue</label>
                                    </div>
                                    ...
                                    <div class="developer-env-section">
                                        <div class="developer-env-head">
                                            ...
                                            <button class="btn btn-secondary btn-sm" id="addDevEnvVarBtn"><i class="fas fa-plus"></i> Add</button>
                                        </div>
                                    ...
                                    <div class="modal-actions">
                                        <button class="btn btn-secondary" id="developerPreviewBtn"><i class="fas fa-eye"></i> Preview Manifest</button>
                                        <button class="btn btn-primary" id="developerDeployBtn"><i class="fas fa-rocket"></i> Deploy to Cluster</button>
                                    </div>
                                </div>
                            </div>
                        </div>
