 (function() {
    ...
    el.innerHTML = `            <div class="page-content" id="cicdtemplatesPage">
                <div class="list-header">
                    <div class="list-controls">
                        <input type="text" data-i18n-placeholder="cicd.searchTemplate" placeholder="템플릿 검색..." style="padding:8px 14px;border:1.5px solid #2d3748;border-radius:8px;font-size:14px;background:#1e293b;color:#e2e8f0;width:220px;" oninput="filterCicdTemplates(this.value)">
                    </div>
                </div>

                <div style="padding:0 24px 32px;">
                    <div class="info-banner info-banner-indigo">
                        <i class="fas fa-info-circle"></i>
                        <span data-i18n="cicd.appDeployInfo">Application 배포 파이프라인 템플릿입니다. 템플릿 선택 → 파라미터 입력 → Pipeline 자동 생성.</span>
                    </div>

                    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:20px;" id="cicdTemplateGrid">

                        <!-- Template 1: Web Frontend -->
                        <div class="pipeline-card cicd-template-card" data-name="web frontend react nextjs">
                            <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:14px;">
                                <div style="display:flex;align-items:center;gap:10px;">
                                    <div class="template-card-icon" style="background:linear-gradient(135deg,#3b82f6,#2563eb);">
                            ...
                            <button onclick="alert('Web Frontend 템플릿 배포 설정\n\nRepo URL: ____________\nImage Name: ____________\nNamespace: ____________\n\n→ CI/CD Pipeline 자동 생성됩니다.')" style="width:100%;padding:10px;background:linear-gradient(135deg,#3b82f6,#2563eb);color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;transition:opacity 0.2s;" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'">
                                <i class="fas fa-rocket" style="margin-right:6px;"></i><span data-i18n="cicd.addPipeline">Add Pipeline</span>
                            </button>
                        </div>

                        <!-- Template 2: Backend API -->
                        <div class="pipeline-card cicd-template-card" data-name="backend api spring java python fastapi">
                            <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:14px;">
                                <div style="display:flex;align-items:center;gap:10px;">
                            ...
                            <button onclick="alert('Backend API 템플릿 배포 설정\n\nRepo URL: ____________\nImage Name: ____________\nNamespace: ____________\nTrivy Scan: Enabled\n\n→ CI/CD Pipeline 자동 생성됩니다.')" style="width:100%;padding:10px;background:linear-gradient(135deg,#10b981,#059669);color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;transition:opacity 0.2s;" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'">
                                <i class="fas fa-rocket" style="margin-right:6px;"></i><span data-i18n="cicd.addPipeline">Add Pipeline</span>
                            </button>
                        </div>

                        <!-- Template 3: Batch Job -->
                        <div class="pipeline-card cicd-template-card" data-name="batch job python spring cron scheduler">
                            <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:14px;">
                                <div style="display:flex;align-items:center;gap:10px;">
                                    <div class="template-card-icon" style="background:linear-gradient(135deg,#f59e0b,#d97706);">
                            ...
                            <button onclick="alert('Batch Job 템플릿 배포 설정\n\nRepo URL: ____________\nCron Schedule: ____________\nNamespace: ____________\n\n→ Kubernetes CronJob 자동 생성됩니다.')" style="width:100%;padding:10px;background:linear-gradient(135deg,#f59e0b,#d97706);color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;transition:opacity 0.2s;" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'">
                                <i class="fas fa-rocket" style="margin-right:6px;"></i><span data-i18n="cicd.addPipeline">Add Pipeline</span>
                            </button>
                        </div>
